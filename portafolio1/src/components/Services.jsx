        ...
        <div className='flex flex-col gap-4'>
            ...
            <form className='w-full'>
                <div className='relative'>
                    ...
                    />
                    <button type='submit' className='absolute text-lg font-semibold py-2 px-6 bg-primary text-white rounded-xl right-2 top-1/2 -translate-y-1/2 hover:text-gray-300 transition-colors'>Suscribe</button>
                </div>
            </form>
        </div>
        {/* Type of Services */}
